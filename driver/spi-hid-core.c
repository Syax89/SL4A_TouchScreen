...
MODULE_PARM_DESC(hold_frames,
	"Hold grace frames before lifting (slot state 4). Default 0 (disabled — lift immediate). Windows enabled (config+0x8D8=0xB3) but only for tracked contacts with history.");
