...
DefinitionBlock ("", "DSDT", 2, "MSFT  ", "MIN     ", 0x00000000)
{
    ...
    OperationRegion (MNVS, SystemMemory, 0x7C796000, 0x0056)
    ...
    OperationRegion (MSNV, SystemMemory, 0x7C7B4F18, 0x0000003C)
