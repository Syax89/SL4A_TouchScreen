/* FUN_180628960 @ 180628960 | root=false | callers=4 */


undefined8 *
FUN_180628960(longlong *param_1,undefined8 *param_2,char param_3,undefined8 *param_4,
...

{
  ...
  if (0x555555555555553 < (ulonglong)param_1[1]) {
    FUN_180628510(0x555555555555554,param_6);
  ...
  if (param_4 == (undefined8 *)*param_1) {
    ...
    *(longlong **)*param_1 = param_6;
    ...
    param_4[2] = param_6;
    lVar4 = *param_1;
    if (param_4 != *(undefined8 **)(lVar4 + 0x10)) goto LAB_1806289d5;
  }
...
LAB_180628af7:
      ...
      *(undefined1 *)(*(longlong *)(*plVar6 + 8) + 0x18) = 0;
      ...
      if (*(char *)(lVar4 + 0x18) == '\0') goto LAB_180628af7;
      plVar2 = (longlong *)*plVar8;
      plVar5 = plVar8;
      if (plVar7 == plVar2) {
        *plVar8 = plVar2[2];
