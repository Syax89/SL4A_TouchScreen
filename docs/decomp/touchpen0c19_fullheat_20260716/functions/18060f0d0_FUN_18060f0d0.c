/* FUN_18060f0d0 @ 18060f0d0 | root=false | callers=1 */


/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */

undefined8 FUN_18060f0d0(char *param_1)

{
  ...
  if (5 < DAT_1809429f0) {
    local_40._4_4_ = ZEXT24(DAT_1807e76d4);
  ...
  param_1[0xf] = '\x01';
  cVar3 = '\0';
  param_1[0x10] = *(char *)(lVar1 + 0x26ac) == '\x01';
