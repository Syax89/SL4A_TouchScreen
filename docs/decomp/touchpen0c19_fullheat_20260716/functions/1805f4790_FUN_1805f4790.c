/* FUN_1805f4790 @ 1805f4790 | root=false | callers=1 */


undefined8 *
FUN_1805f4790(longlong *param_1,undefined8 *param_2,longlong *param_3,uint *param_4,
             undefined8 param_5)

{
  ...
  if (param_1[1] == 0) {
    FUN_1805f5260(param_1,param_2,1,plVar3);
  }
  else {
    if (param_3 == (longlong *)*plVar3) {
      if (*param_4 < *(uint *)(param_3 + 4)) {
        FUN_1805f5260(param_1,param_2,1,param_3);
        return param_2;
      }
    }
    else if (param_3 == plVar3) {
      if (*(uint *)(plVar3[2] + 0x20) < *param_4) {
        FUN_1805f5260(param_1,param_2,0);
        return param_2;
      }
    }
    else {
      ...
      if (*(uint *)(param_3 + 4) < uVar2) {
        ...
        if ((plVar8 == plVar3) || (uVar2 < *(uint *)(plVar8 + 4))) {
          if (*(char *)((longlong)plVar7 + 0x19) != '\0') {
            FUN_1805f5260(param_1,param_2,0,param_3);
            return param_2;
          }
          FUN_1805f5260(param_1,param_2,1);
          return param_2;
        }
      }
    }
    puVar6 = (undefined8 *)FUN_1805f5510(param_1,local_20,param_3,param_4,param_5);
    *param_2 = *puVar6;
  }
  return param_2;
}
