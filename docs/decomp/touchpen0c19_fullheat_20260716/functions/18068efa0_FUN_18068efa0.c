/* FUN_18068efa0 @ 18068efa0 | root=false | callers=1 */


/* WARNING: Function: __security_check_cookie replaced with injection: security_check_cookie */

void FUN_18068efa0(longlong param_1)

{
  ...
  if (4 < DAT_1809429f0) {
    local_40._4_4_ = ZEXT24(DAT_1807eddb6);
    ...
    local_20 = &DAT_1807eddc0;
    local_30.Reserved = 2;
    local_18 = 0x2c;
    local_14 = 1;
    EventWriteTransfer(DAT_180942a10,&local_40,(LPCGUID)0x0,(LPCGUID)0x0,2,&local_30);
  }
  FUN_18066a730(*(undefined8 *)(param_1 + 0x21408));
  *(undefined1 *)(param_1 + 0x213fa) = 1;
  return;
}
