/* FUN_1805f4110 @ 1805f4110 | root=false | callers=2 */


longlong * FUN_1805f4110(undefined8 *param_1,int *param_2)

{
  ...
  if (*(char *)(plVar1[1] + 0x19) == '\0') {
    ...
    if ((plVar6 != plVar1) && ((int)plVar6[4] <= *param_2)) goto LAB_1805f420b;
  }
  ...
  *(undefined2 *)(puVar4 + 3) = 0;
  FUN_1805f4550(param_1,&local_res8,plVar6,puVar4 + 4,puVar4);
  plVar6 = local_res8;
LAB_1805f420b:
  return plVar6 + 5;
}
