/* FUN_18066ae50 @ 18066ae50 | root=false | callers=1 */


undefined8 *
FUN_18066ae50(longlong *param_1,undefined8 *param_2,undefined8 param_3,ulonglong *param_4,
             void *param_5)

{
  ...
  if (*(char *)((longlong)puVar4 + 0x19) == '\0') {
    do {
      puVar3 = puVar4;
      bVar5 = *param_4 < (ulonglong)puVar3[4];
      if (bVar5) {
  ...
  if (bVar5 != false) {
    if (puVar3 == (undefined8 *)*puVar2) {
      puVar2 = (undefined8 *)
               FUN_180628960(param_1,local_res8,CONCAT71((int7)((ulonglong)puVar4 >> 8),1));
      *param_2 = *puVar2;
  ...
  if ((ulonglong)puVar3[4] < *param_4) {
    puVar2 = (undefined8 *)FUN_180628960(param_1,local_res8,bVar5);
    *param_2 = *puVar2;
    *(undefined1 *)(param_2 + 1) = 1;
  }
  else {
