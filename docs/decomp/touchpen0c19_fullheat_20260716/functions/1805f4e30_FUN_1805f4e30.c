/* FUN_1805f4e30 @ 1805f4e30 | root=false | callers=2 */


undefined8 *
FUN_1805f4e30(longlong *param_1,undefined8 *param_2,char param_3,undefined8 *param_4,
...

{
  ...
  if (0x492492492492490 < (ulonglong)param_1[1]) {
    FUN_1805f49e0(0x492492492492491,param_6);
  ...
  if (param_4 == (undefined8 *)*param_1) {
    ...
    *(longlong **)*param_1 = param_6;
    ...
    param_4[2] = param_6;
    lVar4 = *param_1;
    if (param_4 != *(undefined8 **)(lVar4 + 0x10)) goto LAB_1805f4ea5;
  }
...
LAB_1805f4fc7:
      ...
      *(undefined1 *)(*(longlong *)(*plVar6 + 8) + 0x18) = 0;
      ...
      if (*(char *)(lVar4 + 0x18) == '\0') goto LAB_1805f4fc7;
      plVar2 = (longlong *)*plVar8;
      plVar5 = plVar8;
      if (plVar7 == plVar2) {
        *plVar8 = plVar2[2];
