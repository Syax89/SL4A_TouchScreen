/* FUN_1805f50e0 @ 1805f50e0 | root=false | callers=1 */


undefined8 *
FUN_1805f50e0(longlong *param_1,undefined8 *param_2,undefined8 param_3,int *param_4,void *param_5)

{
  ...
  if (bVar5 != false) {
    if (puVar3 == (undefined8 *)*puVar2) {
      puVar2 = (undefined8 *)
               FUN_1805f4e30(param_1,local_res8,CONCAT71((int7)((ulonglong)puVar4 >> 8),1));
      *param_2 = *puVar2;
  ...
  if (*(int *)(puVar3 + 4) < *param_4) {
    puVar2 = (undefined8 *)FUN_1805f4e30(param_1,local_res8,bVar5);
    *param_2 = *puVar2;
    *(undefined1 *)(param_2 + 1) = 1;
  }
  else {
    FUN_1805f56b0((longlong)param_5 + 0x28,(longlong)param_5 + 0x28);
    free(param_5);
    *param_2 = puVar3;
