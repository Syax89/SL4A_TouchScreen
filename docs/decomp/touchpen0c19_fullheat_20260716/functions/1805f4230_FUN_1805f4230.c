/* FUN_1805f4230 @ 1805f4230 | root=false | callers=1 */


undefined8 * FUN_1805f4230(longlong *param_1,uint *param_2)

{
  ...
  if (*(char *)((longlong)puVar1[1] + 0x19) == '\0') {
    ...
    if ((puVar5 != puVar1) && (*(uint *)(puVar5 + 4) <= *param_2)) goto LAB_1805f42e9;
  }
  plVar4 = (longlong *)FUN_1805d7c90(0x38);
  ...
  *(undefined2 *)(plVar4 + 3) = 0;
  FUN_1805f4790(param_1,&local_res8,puVar5,plVar4 + 4,plVar4);
  puVar5 = local_res8;
LAB_1805f42e9:
  return puVar5 + 5;
}
