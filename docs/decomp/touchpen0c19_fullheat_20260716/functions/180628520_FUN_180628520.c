/* FUN_180628520 @ 180628520 | root=false | callers=2 */


undefined8 *
FUN_180628520(longlong *param_1,undefined8 *param_2,char param_3,undefined8 *param_4,
...

{
  ...
  if (0x492492492492490 < (ulonglong)param_1[1]) {
    FUN_1806284c0(0x492492492492491,param_6);
  ...
  if (param_4 == (undefined8 *)*param_1) {
    ...
    *(longlong **)*param_1 = param_6;
    ...
    param_4[2] = param_6;
    lVar4 = *param_1;
    if (param_4 != *(undefined8 **)(lVar4 + 0x10)) goto LAB_180628595;
  }
...
LAB_1806286b7:
      ...
      *(undefined1 *)(*(longlong *)(*plVar6 + 8) + 0x18) = 0;
      ...
      if (*(char *)(lVar4 + 0x18) == '\0') goto LAB_1806286b7;
      plVar2 = (longlong *)*plVar8;
      plVar5 = plVar8;
      if (plVar7 == plVar2) {
        *plVar8 = plVar2[2];
