/* FUN_180628280 @ 180628280 | root=false | callers=2 */


undefined8 *
FUN_180628280(longlong *param_1,undefined8 *param_2,longlong *param_3,uint *param_4,
             undefined8 param_5)

{
  ...
  if (param_1[1] == 0) {
    FUN_180628960(param_1,param_2,1,plVar3);
  }
  else {
    ...
    puVar6 = (undefined8 *)FUN_180628c10(param_1,local_20,param_3,param_4,param_5);
    *param_2 = *puVar6;
  }
  return param_2;
}
